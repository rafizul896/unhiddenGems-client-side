    ...
    return (
        <div className="rounded-lg pb-5">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="flex flex-col items-center border p-2 shadow-lg">
                    <img
                        src="https://i.ibb.co/3M60w5W/tour-Guides1.jpg"
                        alt="Tour Guide"
                        className="w-full h-64 object-cover rounded-lg shadow-md mb-4"
                    />
                    <h2 className="text-[22px] font-semibold mb-2">Experienced Tour Guides</h2>
                ...
                <div className="flex flex-col items-center border p-2 shadow-lg">
                    <img
                        ...
                        className="w-full h-64 object-cover rounded-lg shadow-md mb-4"
                    />
                    <h2 className="text-[22px] font-semibold mb-2">Exciting Destinations</h2>
                ...
                <div className="flex flex-col items-center border p-2 shadow-lg">
                    <img
                        ...
                        className="w-full h-64 object-cover rounded-lg shadow-md mb-4"
                    />
                    <h2 className="text-[22px] font-semibold mb-2">Customizable Packages</h2>
                ...
                <div className="flex flex-col items-center border p-2 shadow-lg">
                    <img
                        ...
                        className="w-full h-64 object-cover rounded-lg shadow-md mb-4"
                    />
                    <h2 className="text-[22px] font-semibold mb-2">Customer Satisfaction</h2>
